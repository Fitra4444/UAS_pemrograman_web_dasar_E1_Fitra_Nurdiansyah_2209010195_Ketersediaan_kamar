...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jun 2024 pada 10.00
...
CREATE TABLE `fasilitas` (
  `id` int(11) NOT NULL,
  `fasilitas_diterima` varchar(255) NOT NULL,
...
CREATE TABLE `pasien` (
  ...
  `tanggalkeluar_out` date NOT NULL,
...
--
ALTER TABLE `pasien`
  ADD CONSTRAINT `fk_kamar_id` FOREIGN KEY (`kamar_id`) REFERENCES `kamar` (`id`);
COMMIT;
